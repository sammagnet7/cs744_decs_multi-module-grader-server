...
#define CONFIGURE_ARGS " '--disable-debug' '--prefix=/opt/homebrew/Cellar/libpq/16.1' '--with-gssapi' '--with-openssl' '--libdir=/opt/homebrew/opt/libpq/lib' '--includedir=/opt/homebrew/opt/libpq/include' 'CC=clang' 'CXX=clang++' 'PKG_CONFIG_PATH=/opt/homebrew/opt/icu4c/lib/pkgconfig:/opt/homebrew/opt/openssl@3/lib/pkgconfig:/opt/homebrew/opt/krb5/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/opt/homebrew/Library/Homebrew/os/mac/pkgconfig/14'"
...
#define PG_VERSION_STR "PostgreSQL 16.1 on aarch64-apple-darwin23.0.0, compiled by Apple clang version 15.0.0 (clang-1500.0.40.1), 64-bit"
